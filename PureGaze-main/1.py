...
class GazeEstimationModel_img_with_Latent(GazeEstimationAbstractModel_img_with_latent):
    def __init__(self):
        ...
        # self.reduction = nn.Linear(3072, 300)

        for param in self.feature_extractor.parameters():
            param.requires_grad = True

        self.fc = GazeEstimationAbstractModel_img_with_latent._create_fc_layers(in_features=3072, out_features=2)
